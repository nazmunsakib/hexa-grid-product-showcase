<?php
/**
 * Slider Layout Template - Style 3 (Minimal Cosmetic Card)
 *
 * Mirrors the Grid Layout Style 3 design inside a Swiper carousel:
...
?>
<div class="hexagrid-layout-slider hexagrid-<?php echo esc_attr( $style ); ?> hexagrid-product-grid-3 swiper" role="list">
