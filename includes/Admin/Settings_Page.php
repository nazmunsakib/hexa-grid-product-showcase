        ...
        <div class="wrap">
            ...
            <div class="hexagrid-admin-content" style="background: #fff; padding: 20px; border: 1px solid #ccd0d4; box-shadow: 0 1px 1px rgba(0,0,0,.04); max-width: 800px; margin-top: 20px;">
                ...
                <ol>
                    ...
                    <li><?php echo wp_kses_post( __( 'Configure your layout (Grid, List, Slider, Table), columns, and product limits in the <strong>Showcase Settings</strong> box.', 'hexa-grid-product-showcase' ) ); ?></li>
